...
const ExploreMenu = ({category, setCategory}) => {
    ...
    return(
        <ExploreMenuContainer id="explore-menu">
            ...
            <p className="explore-menu-text">Choose from a diverse menu featuring a dectable array of dishes. Our mission is to satisfy your cravings and elevate your dining experience, one delicious meal at a time
            </p>
                    ...
                    menu_list.map((item,index) => {
                        return(
                            <div onClick={() => setCategory(prev => prev === item.menu_name ? 'All':item.menu_name)} 
                                ...
                                {/* if the category is same as item.menu_name then the classname is set to active */}
